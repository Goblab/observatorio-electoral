...
* cd irreversible-backend
* sudo npm install
* sudo bower install -allow-root
* sails lift

## IMPORTANTE
Una vez que levante el server, les va a pedir el password del certificado, es el siguiente: sooS1wee

Una vez instalado reemplazar de node_modules/waterlock/lib el contenido del archivo cyrcle.js por el siguiente:
```
'use strict';
...
module.exports = function(){
  ...
  return {  
    ...
    loginSuccess: function(req, res, user){
      ...
      //   user);
      // waterlock.logger.debug(req.session.authenticated);
