  ...
  authMethod: [
    {
      ...
      passwordReset:{
        ...
        mail: {
          ...
          options:{
            service: 'Gmail',
            auth: {
              user: 'contacto@irreversible.cc',
              pass: 'tecnomunicipal'
            }
          },
          from: 'no-reply@irreversible.cc',
          subject: 'Su contraseña fue receteada!',
          forwardUrl: 'http://irreversible.cc'
        },  
        template:{
      ...
      createUser:{
        ...
        mail: {
          ...
          from: 'no-reply@irreversible.cc',
          subject: 'Se le ha otorgado acceso a Irreversible!',
          forwardUrl: 'http://irreversible.cc'
        },  
        template:{
          file: '../views/create-user-email.jade',
          vars:{}
        }
      },      
